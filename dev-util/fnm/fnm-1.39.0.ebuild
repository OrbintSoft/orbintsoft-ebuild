...
# CRATES and the dependent-crate LICENSE list are autogenerated by pycargoebuild;
# regenerate on bump with: pycargoebuild <fnm-source-dir> (see CONTRIBUTING.md).
...
SRC_URI="
	https://github.com/Schniz/fnm/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
# ring is not SPDX-tagged upstream: ISC-style for its own code (listed above),
# OpenSSL for the BoringSSL-derived parts.
LICENSE+=" openssl"
SLOT="0"
KEYWORDS="~amd64"
